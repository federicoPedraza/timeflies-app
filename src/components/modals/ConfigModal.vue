...
<template>
    <Modal>
        <div class="flex flex-col md:flex-row justify-between items-start w-full md:w-3/4 bg-white rounded-2xl h-full md:h-2/3">
            <!-- Left sidebar - hidden on mobile -->
            <div class="hidden md:flex flex-col justify-start w-1/4 shadow-lg items-start h-full gap-4 p-8">
                ...
                <div class="flex flex-col h-full justify-end w-full">
                    ...
                    <span class="text-xs text-gray-500 leading-loose">
                        © 2025 - Made by <a href="https://www.linkedin.com/in/federico-pedraza/" target="_blank" class="underline hover:text-[#0EA5E9] transition-all duration-300">Federico Pedraza</a>
                    </span>
                </div>
            </div>

            <!-- Content area - full width on mobile -->
            <div class="flex flex-col md:flex-row justify-start border-l-2 border-gray-200 shadow-lg bg-gray-100 w-full md:w-3/4 rounded-2xl p-2 items-start h-full">
                <div class="w-full flex flex-col md:flex-row justify-end items-start h-full p-4 gap-4">
                    <!-- Mobile section headers -->
                    <div class="flex md:hidden flex-row gap-2 overflow-x-auto w-full pb-4">
                        <button
                            class="flex-shrink-0 flex justify-center items-center h-full rounded-full bg-gray-100 shadow-md hover:shadow-lg transition-all duration-300 border-2"
                            @click="emit('close')">
                            <img src="@/assets/icons/circle-x.svg" alt="close" class="w-8 h-4 rounded-full" />
                            </button>
                        <button type="button" @click="handleTabClick('account')" class="flex justify-center items-center gap-2 bg-gray-50 shadow-md hover:shadow-lg transition-all duration-300 rounded-2xl py-2 px-4 border-2 whitespace-nowrap"
                        :class="{ 'border-2 border-[#0EA5E9]/50 bg-[#0EA5E9]/5': activeTab === 'account' }">
                            <img src="@/assets/icons/user-icon.svg" alt="account" class="w-4 h-4" />
                            <h1 class="text-sm font-semibold">Account</h1>
                        </button>
                        <button type="button" @click="handleTabClick('appearance')" class="flex justify-center items-center gap-2 bg-gray-50 shadow-md hover:shadow-lg transition-all duration-300 rounded-2xl py-2 px-4 border-2 whitespace-nowrap"
                        :class="{ 'border-2 border-[#0EA5E9]/50 bg-[#0EA5E9]/5': activeTab === 'appearance' }">
                            <img src="@/assets/icons/swatch-book.svg" alt="appearance" class="w-4 h-4" />
                            <h1 class="text-sm font-semibold">Appearance</h1>
                        </button>
                        <button type="button" @click="handleTabClick('time')" class="flex justify-center items-center gap-2 bg-gray-50 shadow-md hover:shadow-lg transition-all duration-300 rounded-2xl py-2 px-4 border-2 whitespace-nowrap"
                        :class="{ 'border-2 border-[#0EA5E9]/50 bg-[#0EA5E9]/5': activeTab === 'time' }">
                            <img src="@/assets/icons/clock-icon.svg" alt="time" class="w-4 h-4" />
                            <h1 class="text-sm font-semibold">Time</h1>
                        </button>
                        <button type="button" @click="handleTabClick('privacy')" class="flex justify-center items-center gap-2 bg-gray-50 shadow-md hover:shadow-lg transition-all duration-300 rounded-2xl py-2 px-4 border-2 whitespace-nowrap"
                        :class="{ 'border-2 border-[#0EA5E9]/50 bg-[#0EA5E9]/5': activeTab === 'privacy' }">
                            <img src="@/assets/icons/cookie.svg" alt="privacy" class="w-4 h-4" />
                            <h1 class="text-sm font-semibold">Privacy</h1>
                        </button>
                    ...
                    <button
                        class="hidden md:flex justify-center items-center p-1 rounded-full bg-gray-200 hover:bg-gray-200 hover:shadow-md"
                        @click="emit('close')">
